...
const openrouterHeaders = {
  ...
  "HTTP-Referer": process.env.APP_URL || "https://mockhire.onrender.com",
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (!role || !interviewType) {
        return res
          .status(400)
          .json({ message: "Role and interview type are required" });
      }
...
Generate one coding problem relevant for the role of ${
          isCustomRole === "true" ? "(Custom Role)" : ""
        } ${role}.
