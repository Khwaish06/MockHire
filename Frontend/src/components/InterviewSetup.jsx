...
return ( <div className="home-container"> <div className="glass-card"> <h2 className="main-title">Interview Setup</h2> <p className="subtitle">Select your preferences to begin</p>
